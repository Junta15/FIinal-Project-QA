...
class Module_Buzz(unittest.TestCase): 
    ...
    def test_update_status(self):
        ...
        time.sleep(2)
        driver.find_element(By.ID,"createPost_content").send_keys("Software Quality Assurance.")
        time.sleep(2)
    ...
    def test_input_komentar(self):
        ...
        driver.find_element(By.ID, "menu_buzz_viewBuzz").click()
        time.sleep(3)
        driver.find_element(By.ID,"commentBoxNew_listId17").send_keys("Quality Assurance .")
        time.sleep(3)
