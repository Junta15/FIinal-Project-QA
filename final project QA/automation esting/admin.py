...
class Module_Admin(unittest.TestCase): 
    ...
    def test_A_success_search(self):
        ...
        time.sleep(4)
        driver.find_element(By.XPATH, "/html/body/div[1]/div[1]/div[1]/aside/nav/div[2]/ul/li[1]/a/svg").click()
        time.sleep(3)
    ...
    def test_c_success_add_user(self):
        driver = self.driver
        driver.get("https://opensource-demo.orangehrmlive.com/")
        time.sleep(3)
        driver.find_element(By.ID,"txtUsername").send_keys("Admin") # isi email
    ...
    def test_d_failed_add_user(self):
        driver = self.driver
        driver.get("https://opensource-demo.orangehrmlive.com/")
        time.sleep(3)
        driver.find_element(By.ID,"txtUsername").send_keys("Admin") # isi email
    ...
    def test_E_add_data_skill(self):
        driver = self.driver
        driver.get("https://opensource-demo.orangehrmlive.com/")
        time.sleep(3)
        driver.find_element(By.ID,"txtUsername").send_keys("Admin") # isi email
